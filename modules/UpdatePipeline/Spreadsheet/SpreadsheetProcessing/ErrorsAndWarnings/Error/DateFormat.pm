package UpdatePipeline::Spreadsheet::SpreadsheetProcessing::ErrorsAndWarnings::Error::DateFormat;
...
has 'description' => ( is => 'ro', isa => 'Str',        default => 'date format not recognised' );
