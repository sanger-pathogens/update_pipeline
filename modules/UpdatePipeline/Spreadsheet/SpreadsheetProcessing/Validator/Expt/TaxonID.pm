...
sub _build_error_list
{
    ...
    {
        # not defined
        push @error_list, UpdatePipeline::Spreadsheet::SpreadsheetProcessing::ErrorsAndWarnings::Error::TaxonIDMissing->new();
        return \@error_list;
    }
    ...
    {
        # not integer
        push @error_list, UpdatePipeline::Spreadsheet::SpreadsheetProcessing::ErrorsAndWarnings::Error::TaxonIDFormat->new();        
    }
    elsif( $self->cell_data == 0 )
    {
        # zero
        push @error_list, UpdatePipeline::Spreadsheet::SpreadsheetProcessing::ErrorsAndWarnings::Error::TaxonIDZero->new(); 
    }
