...
ok(my $warehouse_study_with_no_group = MLWarehouse::Study->new(file_meta_data => $filemd_no_group, _dbh => $dbh), 'initialise warehouse study object with file metadata for no group');
...
ok(my $warehouse_study_with_one_group = MLWarehouse::Study->new(file_meta_data => $filemd_one_group, _dbh => $dbh), 'initialise warehouse study object with file metadata for one group');
...
ok(my $warehouse_study_with_two_group = MLWarehouse::Study->new(file_meta_data => $filemd_two_group, _dbh => $dbh), 'initialise warehouse study object with file metadata for two groups');
