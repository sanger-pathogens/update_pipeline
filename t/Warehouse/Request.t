...
ok (Warehouse::Request->new(file_meta_data => $file_meta_data_with_target_asset, _dbh => $dbh)->post_populate()), 'init warehouse and populate frag sizes';
...
ok (Warehouse::Request->new(file_meta_data => $file_meta_data_with_nonexistant_library_ssid, _dbh => $dbh)->post_populate()), 'init warehouse and dont populate frag sizes';
...
ok !(Warehouse::Request->new(file_meta_data => $file_meta_data_with_undef_library_ssid, _dbh => $dbh)->post_populate()), 'init warehouse and dont populate frag sizes';
...
ok (Warehouse::Request->new(file_meta_data => $file_meta_data_where_frag_sizes_exist, _dbh => $dbh)->post_populate()), 'init warehouse and dont update frag sizes';
