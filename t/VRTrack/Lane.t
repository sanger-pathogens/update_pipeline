...
# valid lane creation
ok my $lane = UpdatePipeline::VRTrack::Lane->new(name  => '1234_5#6', total_reads => 1000 ,_vrtrack => $vrtrack,_vr_library => $vr_library), 'initialise valid lane';
...
ok my $vr_lane2 = UpdatePipeline::VRTrack::Lane->new(name  => '1234_5#6', total_reads => 1000 ,_vrtrack => $vrtrack,_vr_library => $vr_library)->vr_lane(), 'find existing lane';
...
ok my $vr_lane3 = UpdatePipeline::VRTrack::Lane->new(name  => '1234_5#6', total_reads => 1000 ,_vrtrack => $vrtrack,_vr_library => $vr_library3)->vr_lane(), 'initialise update library';
