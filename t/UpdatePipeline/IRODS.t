...
ok my $update_pipelines_irods = UpdatePipeline::IRODS->new( study_names => \@study_names, _warehouse_dbh => "abc", _gclp_warehouse_dbh => 'abc'), 'Initialise valid irods study names';
...
ok $update_pipelines_irods = UpdatePipeline::IRODS->new( study_names => \@study_names, _warehouse_dbh => "abc", _gclp_warehouse_dbh => 'abc', specific_min_run => 2001), 'Initialise valid irods with min run';
